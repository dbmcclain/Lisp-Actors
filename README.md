...
(Actors always respect the arrival order of messages in the event queue, but when a message arrives on the event queue may be out of order with respect to when it was actually sent.)
