...
But this doesn't scale well. There is some machine limit to the number of threads that the system can handle. Attempting to distribute the code among several servers becomes a communication and coordination chore. The dedicated thread may become under-utilized, as a machine resource.
