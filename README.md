...
We have, now, several instances of applications for Transactional Hewitt Actors:
      ...
      4. Live remote telemetry monitoring of an audio plugin for specialized sound crafting. While the plugin is in use on one computer, another computer on the network can watch live telemetry, in graphical form, of the internal operations of that remote plugin operation.
