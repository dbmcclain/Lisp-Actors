...
(Call/Return would need something like CoRoutines to pull this off. An Actors machine is a natural coroutine machine, since the event handler is a kind of trampoline, even though we are operating in a Call/Return architecture. Trampolining is one method of performing coroutines and continuations.)
