...
For this substrate, the ARM M1 just slightly outperforms the substrate running on Intel i7 (1.04x faster) under best circumstances. But M1 on Apple seems more prone to background workload modulation, and can vary by 2:1 (SEND/dispath timing of 250ns to 440ns) under typical situations. Intel i7 seems to vary from (260ns to 330ns) for the same kinds of system workloads.
