...
(defun axes2 (pane xvector yvectors &rest args &key xrange xlog ylog &allow-other-keys)
...
(defun do-param-plotting (plotfn pane xfn yfn npts args)
  (destructuring-bind ((tmin    tmax)
                       ...
                       (xprepfn ixprepfn)
                       (yprepfn iyprepfn))
      (list (plotter-trange   pane)
            (plotter-tprepfns pane)
            (plotter-xprepfns pane)
            (plotter-yprepfns pane))
