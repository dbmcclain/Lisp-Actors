...
;; --------------------------------------------
;; TREE-TYPE -- a class that distinguishes COMPARE-KEYS and REPLACE-P
...
;; --------------------------------------------
;; *TREE-TYPES* -- a dictionary of unique TREE-TYPEs seen so far. We
;; keep this list so that we can re-use the same distinguisher when
;; marshaling trees.
